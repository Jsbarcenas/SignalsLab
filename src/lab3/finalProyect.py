...
def accShowValues():
    ...
    accMagMediaEntry.insert(END, st.Media2(accFileFftMag))
    accMagMedianEntry.insert(END, st.median(accFileFftMag))
    accMagStandDeviEntry.insert(END, st.variance(accFileFftMag))
    accMagAbsDeviEntry.insert(END, st.varianceABS(accFileFftMag))
    accMagQ1Entry.insert(END, st.q1(accFileFftMag))
    accMagQ3Entry.insert(END, st.q3(accFileFftMag))
    accMagIqrEntry.insert(END, st.iqr(accFileFftMag))
    accMagAsymmetryEntry.insert(END, st.asymmetry(accFileFftMag))
    accMagKurtEntry.insert(END, st.Kurtosis(accFileFftMag))
    accMagVarCoeEntry.insert(END, st.CoeficienteVariacion(accFileFftMag))
    accMagPotencyEntry.insert(END, st.potency(accFileFftMag))
    # Freq
    accFreqMediaEntry.insert(END, st.media(accFileFftFreq))
    accFreqMedianEntry.insert(END, st.median(accFileFftFreq))
    accFreqStandDeviEntry.insert(END, st.variance(accFileFftFreq))
    accFreqAbsDeviEntry.insert(END, st.varianceABS(accFileFftFreq))
    accFreqQ1Entry.insert(END, st.q1(accFileFftFreq))
    accFreqQ3Entry.insert(END, st.q3(accFileFftFreq))
    accFreqIqrEntry.insert(END, st.iqr(accFileFftFreq))
    accFreqAsymmetryEntry.insert(END, st.asymmetry(accFileFftFreq))
    accFreqKurtEntry.insert(END, st.Kurtosis(accFileFftFreq))
    accFreqVarCoeEntry.insert(END, st.CoeficienteVariacion(accFileFftFreq))
    accFreqPotencyEntry.insert(END, st.potency(accFileFftFreq))
...
def emgShowVAlues():
    ...
    emgMagMediaEntry.insert(END, st.media(emgFileFftMag))
    emgMagMedianEntry.insert(END, st.median(emgFileFftMag))
    emgMagStandDeviEntry.insert(END, st.variance(emgFileFftMag))
    emgMagAbsDeviEntry.insert(END, st.varianceABS(emgFileFftMag))
    emgMagQ1Entry.insert(END, st.q1(emgFileFftMag))
    emgMagQ3Entry.insert(END, st.q3(emgFileFftMag))
    emgMagIqrEntry.insert(END, st.iqr(emgFileFftMag))
    emgMagAsymmetryEntry.insert(END, st.asymmetry(emgFileFftMag))
    emgMagKurtEntry.insert(END, st.Kurtosis(emgFileFftMag))
    emgMagVarCoeEntry.insert(END, st.CoeficienteVariacion(emgFileFftMag))
    emgMagPotencyEntry.insert(END, st.potency(emgFileFftMag))
    # Freq
    emgFreqMediaEntry.insert(END, st.media(emgFileFftFreq))
    emgFreqMedianEntry.insert(END, st.median(emgFileFftFreq))
    emgFreqStandDeviEntry.insert(END, st.variance(emgFileFftFreq))
    emgFreqAbsDeviEntry.insert(END, st.varianceABS(emgFileFftFreq))
    emgFreqQ1Entry.insert(END, st.q1(emgFileFftFreq))
    emgFreqQ3Entry.insert(END, st.q3(emgFileFftFreq))
    emgFreqIqrEntry.insert(END, st.iqr(emgFileFftFreq))
    emgFreqAsymmetryEntry.insert(END, st.asymmetry(emgFileFftFreq))
    emgFreqKurtEntry.insert(END, st.Kurtosis(emgFileFftFreq))
    emgFreqVarCoeEntry.insert(END, st.CoeficienteVariacion(emgFileFftFreq))
    emgFreqPotencyEntry.insert(END, st.potency(emgFileFftFreq))
